...
## 最小复现用例
- [return_unistd_posix.c](file://$SLICING_REPO/issues/015-posix-pid_t-missing/cases/return_unistd_posix.c)

对应切片导出产物：
- [return_unistd_posix.sliced.c](file://$SLICING_REPO/issues/015-posix-pid_t-missing/artifacts/return_unistd_posix.sliced.c)
