...
## 复现用例
- [return_varargs_stdarg.c](file://$SLICING_REPO/issues/005-varargs-broken-export/cases/return_varargs_stdarg.c)

对应切片导出产物：
- [return_varargs_stdarg.sliced.c](file://$SLICING_REPO/issues/005-varargs-broken-export/artifacts/return_varargs_stdarg.sliced.c)
