...
def main() -> int:
    ...
    parser.add_argument("--csmith-binary", default=os.environ.get("CSMITH_BINARY", "csmith"))
    parser.add_argument("--csmith-include-dir", default=os.environ.get("CSMITH_INCLUDE_DIR", "/usr/include/csmith"))
    parser.add_argument("--clang-binary", default=os.environ.get("CLANG_BIN", "clang"))
